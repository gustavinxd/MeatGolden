    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.cardshome}>
          ...
          <CardHome onPress={() => navigation.navigate('Suina')} title='Suína' uri='https://www.tribunapr.com.br/wp-content/uploads/sites/81/2022/02/16140732/Carne-Suina_baixa-970x550.jpg'/>
        </View>
      </ScrollView>
    </View>
  );
